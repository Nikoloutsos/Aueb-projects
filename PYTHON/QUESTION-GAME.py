...
class Question_Game:
    quest = {
1:["Ποιά είναι η μεγαλύτερη χώρα;",["Ελλάδα","Κίνα","Βουλγαρία","Ισπανία"],["Κίνα"]],
2:["Ποια νότα είναι μετά την λα;",["ντο","φα","σι","μι"],["σι"]],
3:["Ποιο σύμβολο ονομάζεται παραγοντικό;",["+","!","<","S"],["!"]],
4:["Ποιος καλλιτέχνης έχει ερμηνεύσει περισσότερα τραγούδια;",["Μαρτάκης","Ρέμος","Ασλανίδου","Παντελίδης"],["Ρέμος"]],
5:["Ποιος ποιητής έγραψε τον Εθνικό Ύμνο¨",["Σεφέρης","Καζαντζάκης","Σολωμός","Παλαμάς"],["Σολωμός"]],
6:["Πότε έγινε η άλωση της Κων/λης;",["1450","1451","1483","1453"],["1453"]],
7:["Πότε μπήκε η Ελλάδα στην Ε.Ε;",["1990","2001","2002","2000"],["2001"]],
8:["Ποιος είναι ο μεγαλύτερος ποταμός της Γης;",["Τίγρης","Αμαζόνιος","Ευφράτης","Δούναβης"],["Αμαζόνιος"]],
9:["Ποιο είναι το αποτέλεσμα της παράστασης Α = 2/4*3 σε έναν υπολογιστή;",["0","3/2","6","1/6"],["3/2"]],
10:["Τι σημαίνει η λέξη famous;",["Χοντός","Ψηλός","Όμορφος","Γνωστός"],["Γνωστός"]],
11:["Ποιο είναι το συνώνυμο της λέξης αδαής;",["Έξυπνος","Άσχετος","Απρεπής","Άγνωστος"],["Άσχετος"]],
12:["Πώς συμβολίζεται η νότα φα;",["G","F","E","Fm"],["F"]],
13:["Ποια ομάδα έχει πιο σταθερά στοιχεία;",["Αλκάλια","Αλκαλικές Γαίες","Αμέταλλα","Ευγενή Αέρια"],["Ευγενή Αέρια"]],
14:["Ποιο είναι το αντίθετο του μπροστά;",["Δίπλα","Πίσω","Απέναντι","Κάτω"],["Πίσω"]],
15:["Πότε έγιναν οι Ολυμπιακοί αγώνες στην Ελλάδα;",["1990","2000","2004","2010"],["2004"]]
    }
    players_self = []
