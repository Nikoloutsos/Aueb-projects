...
class RandomGeneratorImproved extends acm.util.RandomGenerator{
	...
	/*public static void main(String args[]){
		...
		System.out.println(rand_powers_of_two(0)); //unit testing for rand_powers_of_two method! 
		System.out.println(rand_powers_of_two(100,3170122)); 
		System.out.println("---------------------------------");
		System.out.println(rand_square(100)); //unit testing for rand_squares method! 
		System.out.println(rand_square(10,15)); 
		System.out.println("---------------------------------");
		System.out.println(rand_prime(152,1000000000)); //unit testing for rand_primes method! https://goo.gl/DDsiuN --> Check it this is a prime number
		System.out.println(rand_prime(1,1)); 
		System.out.println(rand_prime(100,50)); 
		System.out.println(rand_prime(10,12)); 
		System.out.println("---------------------------------");
		for(int i=1;i<=100;i++){
		System.out.println(rand_fibonacci(1,1)); 
		System.out.println(rand_fibonacci(6,1000000000)); 
